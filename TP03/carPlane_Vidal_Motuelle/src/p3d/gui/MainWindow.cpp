...
MainWindow::MainWindow() :
  ...
  format.setVersion(3,1); // there's a bug somewhere for the compatibility profile on AMD driver : comment this line if there's a problem with the openGL version
