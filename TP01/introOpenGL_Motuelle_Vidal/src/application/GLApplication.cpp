...
void GLApplication::initRing(int nbSlice,float r0,float r1){
   ...
   for(int i=0;i<=nbSlice;++i) {
       ...
       _trianglePosition.push_back(0.0);
       _triangleTexCoord.push_back((r0 * cos(theta_courant)+1)/2);
       _triangleTexCoord.push_back(1  - ((r0 * sin(theta_courant))+1)/2);
       _trianglePosition.push_back(r1 * cos(theta_courant));
       _trianglePosition.push_back(r1 * sin(theta_courant));
       _trianglePosition.push_back(0.0);
       _triangleTexCoord.push_back((r1 * cos(theta_courant)+1)/2);
       _triangleTexCoord.push_back(1  - ((r1 * sin(theta_courant))+1)/2);
